                    ...
                    <div className="grid grid-cols-12 mt-8 me-12">
                        ...
                        <div className="col-span-4">
                            <div className="text-center text-coral-pink" style={{ paddingLeft: '50px' }}>
                                <button onClick={() => changeSpeaker("above")}><AiOutlineUp style={{ strokeWidth: '100', width: '32px', height: '48px' }}/></button>
                            </div>
                            ...
                            <div className="text-center text-coral-pink" style={{ marginTop: '10px', paddingLeft: '50px' }}>
                                <button onClick={() => changeSpeaker("below")}><AiOutlineDown style={{ strokeWidth: '100', width: '32px', height: '48px' }}/></button>
                            </div>
                        </div>
                    </div>
                </div>
