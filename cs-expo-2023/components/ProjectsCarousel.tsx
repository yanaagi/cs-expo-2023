  ...
  return (
    <main className="flex justify-center mt-[-20px]">
      ...
      <div className="glide relative">
        ...
        <div className="w-screen ps-40 me-40">
        ...
        <div
          className="glide__arrows w-screen absolute inset-y-2/4 sm:block hidden" // sm:block hidden is for hiding the arrows on small screens
